    ...
    logger = (function () {
        var
            ...
            lgr = {
                ...
                // Ensure that there's a logging-context (a `logContext` member with `id`, `name`,
                // `color`) present on given `opts` object. That is to say, _create it_ if not
                // already there. `url` (a URL object) is used to build the context name, if present
...
Object.defineProperties(exports, {
    version: { get: function () { return "0.1.1"; } }, // Keep version in sync with package.json
